...
export class  $npmConfigName1755143726718 implements MigrationInterface {
    name = ' $npmConfigName1755143726718'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "posts" ("created_at" datetime NOT NULL, "created_by" nvarchar(255) NOT NULL, "id" uniqueidentifier NOT NULL CONSTRAINT "DF_2829ac61eff60fcec60d7274b9e" DEFAULT NEWSEQUENTIALID(), "slug" nvarchar(255) NOT NULL, "title" nvarchar(255) NOT NULL, "summary" nvarchar(255), "content" nvarchar(255), "category" nvarchar(255) NOT NULL, "banner_id" uniqueidentifier NOT NULL, CONSTRAINT "UQ_54ddf9075260407dcfdd7248577" UNIQUE ("slug"), CONSTRAINT "PK_2829ac61eff60fcec60d7274b9e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "REL_a4567dc7906e3bf046941ef467" ON "posts" ("banner_id") WHERE "banner_id" IS NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "posts" ADD CONSTRAINT "FK_a4567dc7906e3bf046941ef467c" FOREIGN KEY ("banner_id") REFERENCES "files"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "posts" DROP CONSTRAINT "FK_a4567dc7906e3bf046941ef467c"`);
        ...
        await queryRunner.query(`DROP INDEX "REL_a4567dc7906e3bf046941ef467" ON "posts"`);
        ...
        await queryRunner.query(`DROP INDEX "REL_af1fa90fb43115943ca660908a" ON "members"`);
