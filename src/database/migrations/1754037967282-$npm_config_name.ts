...
export class  $npmConfigName1754037967282 implements MigrationInterface {
    name = ' $npmConfigName1754037967282'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "posts" ("created_at" datetime NOT NULL, "created_by" nvarchar(255) NOT NULL, "id" uniqueidentifier NOT NULL CONSTRAINT "DF_2829ac61eff60fcec60d7274b9e" DEFAULT NEWSEQUENTIALID(), "slug" nvarchar(255) NOT NULL, "title" nvarchar(255) NOT NULL, "summary" nvarchar(255), "content" nvarchar(255), "banner_id" uniqueidentifier, "category_id" uniqueidentifier NOT NULL, CONSTRAINT "UQ_54ddf9075260407dcfdd7248577" UNIQUE ("slug"), CONSTRAINT "PK_2829ac61eff60fcec60d7274b9e" PRIMARY KEY ("id"))`);
