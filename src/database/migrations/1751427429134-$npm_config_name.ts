...
export class  $npmConfigName1751427429134 implements MigrationInterface {
    name = ' $npmConfigName1751427429134'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "related_posts" ("created_at" datetime2 NOT NULL CONSTRAINT "DF_2b36e3da08a6518f0a5dd48dd9e" DEFAULT getdate(), "created_by" nvarchar(255) NOT NULL, "id" uniqueidentifier NOT NULL CONSTRAINT "DF_34a75acc30bbd46c7e538d2c434" DEFAULT NEWSEQUENTIALID(), "post_id" uniqueidentifier NOT NULL, "related_id" uniqueidentifier NOT NULL, CONSTRAINT "PK_34a75acc30bbd46c7e538d2c434" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "working_history" ADD CONSTRAINT "FK_5f025442e5ae16906636129cd78" FOREIGN KEY ("memberId") REFERENCES "members"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "related_posts" ADD CONSTRAINT "FK_91eeeb02213f66c0f2b452b937f" FOREIGN KEY ("post_id") REFERENCES "posts"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "related_posts" ADD CONSTRAINT "FK_e6a3bd92bbe09ef7f32ebf239f6" FOREIGN KEY ("related_id") REFERENCES "posts"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "related_posts" DROP CONSTRAINT "FK_e6a3bd92bbe09ef7f32ebf239f6"`);
        await queryRunner.query(`ALTER TABLE "related_posts" DROP CONSTRAINT "FK_91eeeb02213f66c0f2b452b937f"`);
        await queryRunner.query(`ALTER TABLE "files" DROP CONSTRAINT "FK_cf385d63a2c2df1516b3d50ff61"`);
        await queryRunner.query(`ALTER TABLE "working_history" DROP CONSTRAINT "FK_5f025442e5ae16906636129cd78"`);
